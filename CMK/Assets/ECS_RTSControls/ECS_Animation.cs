...
namespace ECS_AnimationSystem {
    ...
    public static class ECS_Animation {
        ...
        public static void PlayAnimJobs(Entity entity, int index, EntityCommandBuffer entityCommandBuffer, Skeleton_Data skeletonData, ECS_UnitAnimType.TypeEnum ecsUnitAnimTypeEnum, Vector3 dir, Skeleton_Anim_OnComplete onComplete) {
            PlayAnimJobs(entity, index, entityCommandBuffer, skeletonData, ecsUnitAnimTypeEnum, GetAnimDir(dir), onComplete);
        }

        public static void PlayAnimJobs(Entity entity, int index, EntityCommandBuffer entityCommandBuffer, Skeleton_Data skeletonData, ECS_UnitAnimType.TypeEnum ecsUnitAnimTypeEnum, UnitAnim.AnimDir animDir, Skeleton_Anim_OnComplete onComplete) {
        ...
        public static void PlayAnimForcedJobs(Entity entity, int index, EntityCommandBuffer entityCommandBuffer, ECS_UnitAnimType.TypeEnum ecsUnitAnimTypeEnum, UnitAnim.AnimDir animDir, Skeleton_Anim_OnComplete onComplete) {
            Skeleton_Data skeletonData = GetSkeletonData(ecsUnitAnimTypeEnum, animDir, onComplete);
            entityCommandBuffer.SetComponent(entity, skeletonData);
